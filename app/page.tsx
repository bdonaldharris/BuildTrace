...
const HOW_IT_WORKS = [
  {
    ...
    desc: "Add source chunks — AI chats, terminal output, errors, decisions, commits, notes. No cleanup needed.",
  },
  {
    num: "02",
    step: "Generate",
    title: "Generate the story",
    desc: "Get a clear timeline, key decisions, blockers resolved, and builder takeaways from your raw inputs.",
  },
  {
    num: "03",
    step: "Publish",
    title: "Share the proof",
    desc: "Copy a LinkedIn post, README recap, demo script, or builder reflection. Own your work.",
  },
] as const;
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="border-b border-border bg-background">
        <div className="max-w-5xl mx-auto px-6 py-10">
          ...
          {/* Blackathon badge */}
          <div className="mt-4">
            <span className="inline-flex items-center rounded-full bg-amber-500/10 px-3 py-1 text-xs font-medium text-amber-400 border border-amber-500/20">
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-px bg-border rounded-xl overflow-hidden">
            {HOW_IT_WORKS.map(({ num, step, title, desc }) => (
        ...
        {recap && (
          <div className="space-y-10">
            ...
            <section className="border-t border-border pt-10">
              <p className="text-xs font-mono text-violet-400/60 uppercase tracking-widest mb-2">
                {"// 02. recap"}
              </p>
